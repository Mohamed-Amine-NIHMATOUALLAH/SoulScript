document.addEventListener('DOMContentLoaded', function() {
    ...
    likeButtons.forEach(button => {
        button.addEventListener('click', function(e) {
            ...
            .catch(error => {
                ...
                alert('Une erreur est survenue lors de l\'action "J\'aime". Veuillez réessayer.');
            });
        });
    });
    ...
    commentForms.forEach(form => {
        form.addEventListener('submit', function(e) {
            ...
            const commentsList = document.querySelector(`.comments-list-${articleId}`);
    ...
    commentToggles.forEach(toggle => {
        toggle.addEventListener('click', function(e) {
            e.preventDefault();
            const articleId = this.dataset.id;
            const commentsSection = document.querySelector(`.comments-section-${articleId}`);
